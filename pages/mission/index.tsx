  ...
  return (
    <>
      ...
      <div className='relative h-56 md:h-[34rem]'>
        <Image
          src='https://images.unsplash.com/photo-1546345352-9b13905ebd40?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1808&q=80'
          alt='group cover'
          fill
